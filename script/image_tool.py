...
def clip_image(data_path, save_path):
    ...
    for file in files_list:
        ...
        image_clip = image[500:1012, 500:1012] #图像切片
...
if __name__ == '__main__':
    data_path = 'E:/datasets/denoising/processing_data/blur_test_2'
    save_path = 'E:/datasets/denoising/processing_data/blur_cliped_test_2'
